            ...
            {isAIAnalyzing ? (
              <div className="flex flex-col items-center justify-center py-20 space-y-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground max-w-xs">
                    Our AI is reviewing every section to provide personalized
                    feedback.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  No analysis data available. Click "AI Analyze" to start.
                </p>
              </div>
            ) : (
              <>
                    ...
                    {review.what_to_improve && (
                      <div className="mt-4 pt-4 border-t border-primary/10">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-xs font-bold uppercase tracking-tighter text-warning/80">
                          ...
                          <div className="relative size-24 flex items-center justify-center">
                            <svg className="size-full -rotate-90">
                              ...
                              <circle
                                ...
                                strokeDashoffset={
                                  251.2 - (251.2 * feedback.ats_score) / 100
                                }
                                strokeLinecap="round"
                                className={cn(
                                  "transition-all duration-1000",
                                  getScoreColor(feedback.ats_score),
                                )}
                              />
                            </svg>
                            <span
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {feedback.missing_keywords.map((kw) => (
                              <Badge
                                key={kw}
                                variant="secondary"
                                className="bg-destructive/10 text-destructive border-none text-[10px] font-bold"
                              >
                                {kw}
                              </Badge>
                            ))}
